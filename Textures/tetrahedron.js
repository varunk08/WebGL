...
{
	this.createTriangle(a, b, c, 0);
    	this.createTriangle(d, c, b, 1);
    	this.createTriangle(a, d, b, 2);
    	this.createTriangle(a, c, d, 3);
...
Tetra.prototype.createTriangle = function(a,b,c, index)
{
	...
	//indices
	this.tetFaceIndices.push(index);
	this.tetFaceIndices.push(index);
	this.tetFaceIndices.push(index);
	...
	//tex coords
	this.tetTexCoords.push(vec2(0.5,0.5));
